...
eval("var jwt = __webpack_require__(/*! jsonwebtoken */ \"./node_modules/jsonwebtoken/index.js\");\n\nmodule.exports  = function(token, secretOrKey, options, callback) {\n    return jwt.verify(token, secretOrKey, options, callback);\n};\n\n\n//# sourceURL=webpack:///./node_modules/passport-jwt/lib/verify_jwt.js?");
